...
begin
  PW.OW := StrToInt(Edit_OW.Text);
  PW.OH := StrToInt(Edit_OH.Text);
  PW.PW := StrToInt(Edit_PW.Text);
  PW.PH := StrToInt(Edit_PH.Text);
  PW.OFFX := StrToInt(Edit_OffX.Text);
  PW.OFFY := StrToInt(Edit_OffY.Text);
